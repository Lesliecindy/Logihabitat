...
<body>
  <div class="sidebar">
    <div class="logo-details"> 
      ...
      <ul class="nav-links">
        <li>
          <a href="#" onclick="favoris()">
              <i class='bx bx-heart' id="icon"></i>
              <span class="links_name">Mes favoris</span>
            </a>
          </li>
        <li>
          <a href="#" onclick="messages()">
            <i class='bx bx-message' id="icon"></i>
            <span class="links_name">Mes messages</span>
          </a>
        </li>
        <li>
          <a href="#">
  ...
  <section class="home-section">
    <nav>
      ...
      <span class="greeting">Hello Grace kaena</span>
      </div>
      <div>
...
sidebarBtn.onclick = function() {
 ...
 <script src="js/myscript_client.js"></script>
